...
export default function ServiceCTA({
  ...
  return (
    ...
    >
      {/* Decorative lines */}
      <div
        className="absolute top-0 left-0 w-px h-full bg-[#111111]/8"
        style={{ left: "10%" }}
      />
      <div
        className="absolute top-0 left-0 w-px h-full bg-[#111111]/8"
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10 relative text-center">
        ...
        >
          ...
          <h2
            className="font-display text-[#111111] mb-8 leading-[1.08]"
            style={{
          ...
          >
            {headline}
            <br />
            <span className="text-[#D91A6B] italic">{headlineAccent}</span>
          </h2>
          ...
          {closingLine && (
            <p className="font-body text-[#111111]/40 text-sm mt-6 italic">
              {closingLine}
            </p>
          )}
        </div>
