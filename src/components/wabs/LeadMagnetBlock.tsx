...
function SignupForm({ onSubmit, submitted }: { onSubmit: () => void; submitted: boolean }) {
  ...
  if (submitted) {
    return (
      <div className="bg-[#D91A6B]/20 border border-[#D91A6B]/40 rounded-sm px-8 py-7 text-center">
        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#D91A6B]/30 mb-4">
          <CheckCircle2 size={22} className="text-[#FFFFFF]" />
        </div>
        <h3 className="font-display text-[#FFFFFF] text-xl font-semibold mb-2">Blueprint on its way!</h3>
        <p className="font-body text-[#FFFFFF]/65 text-sm">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div>
        <label className="font-body text-[#FFFFFF]/70 text-xs font-semibold uppercase tracking-wider mb-1.5 block">
          First Name <span className="text-[#D91A6B]">*</span>
        </label>
        <input
          type="text"
          value={firstName}
          ...
          required
          className="w-full bg-[#FFFFFF]/10 border border-[#FFFFFF]/20 text-[#FFFFFF] placeholder-[#FFFFFF]/35 px-4 py-3.5 rounded-sm font-body text-base focus:outline-none focus:border-[#D91A6B] transition-colors"
        />
      </div>
      <div>
        <label className="font-body text-[#FFFFFF]/70 text-xs font-semibold uppercase tracking-wider mb-1.5 block">
          Email Address <span className="text-[#D91A6B]">*</span>
        </label>
        <input
          type="email"
          value={email}
      ...
      <button
        type="submit"
        className="w-full inline-flex items-center justify-center gap-2 bg-[#D91A6B] text-[#FFFFFF] px-6 py-4 rounded-sm font-body font-semibold text-sm hover:bg-[#A01050] transition-all duration-200 hover:scale-[1.02] group mt-1"
      >
        Send me this ASAP
        <ArrowRight size={15} className="transition-transform duration-200 group-hover:translate-x-1" />
      </button>
      <p className="font-body text-[#FFFFFF]/30 text-xs text-center pt-1">
  ...
  return (
    <section id="lead-magnet" className="relative overflow-hidden" ref={ref}>
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #2D2D2D 0%, #111111 65%, #111111 100%)" }}
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 lg:gap-20 items-center">
            ...
            <div className={`transition-[opacity,transform] duration-700 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              ...
              <h2
                className="font-display text-[#FFFFFF] leading-tight mb-6"
                style={{ fontSize: "clamp(34px, 4.5vw, 58px)", fontVariationSettings: '"WONK" 0.7' }}
              >
                The Roadmap to a
                <span className="text-[#D91A6B] italic block">Profitable Online Presence</span>
              </h2>
              <p className="font-body text-[#FFFFFF]/65 text-lg lg:text-xl leading-relaxed max-w-xl">
            ...
            <div className={`transition-[opacity,transform] duration-700 ease-out delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              <div className="bg-[#FFFFFF]/[0.06] border border-[#FFFFFF]/12 rounded-sm p-7 lg:p-8">
                <h3
                  className="font-display text-[#FFFFFF] text-xl lg:text-2xl font-semibold mb-6 leading-snug"
      ...
      {/* ── BODY CONTENT (white) ── */}
      <div className="bg-[#FFFFFF] py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className={`mb-20 transition-[opacity,transform] duration-700 ease-out delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="max-w-3xl">
              ...
              >
                What Most People Get Wrong
                <span className="text-[#D91A6B] italic"> About Launching Their Brand Online</span>
              </h3>
              <p className="font-body text-[#2D2D2D]/65 text-lg leading-relaxed mb-5">
              ...
              <p className="font-body text-[#111111]/75 text-lg font-medium leading-relaxed">
          ...
          <div className={`grid md:grid-cols-3 gap-6 mb-20 transition-[opacity,transform] duration-700 ease-out delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            {pillars.map((pillar, i) => (
              <div
                key={pillar.title}
                className="bg-white rounded-sm p-8 border border-[#E8E8E8] wabs-shadow transition-[opacity,transform] duration-700 ease-out"
                style={{ transitionDelay: `${0.2 + i * 0.1}s` }}
              >
                <div className="inline-flex items-center justify-center w-11 h-11 rounded-sm bg-[#D91A6B]/10 text-[#D91A6B] mb-5">
                  {pillar.icon}
                </div>
                <h4
                  className="font-display text-[#111111] text-xl font-semibold mb-3"
                  style={{ fontVariationSettings: '"WONK" 0.3' }}
                >
                  {pillar.title}
                </h4>
                <p className="font-body text-[#2D2D2D]/60 text-base leading-relaxed">
                  {pillar.description}
                </p>
              </div>
            ))}
          ...
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20 transition-[opacity,transform] duration-700 ease-out delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div>
              ...
              >
                ...
                <span className="text-[#D91A6B] italic block">To Your Online Success</span>
              </h3>
              <p className="font-body text-[#2D2D2D]/65 text-lg leading-relaxed mb-6">
              ...
              <p className="font-body text-[#2D2D2D]/65 text-lg leading-relaxed mb-8">
              ...
              <div className="bg-[#D91A6B]/8 border border-[#D91A6B]/20 rounded-sm px-6 py-5">
                <p className="font-display text-[#111111] text-lg font-semibold italic" style={{ fontVariationSettings: '"WONK" 0.4' }}>
            ...
            <div className="bg-[#111111] rounded-sm p-8 lg:p-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-48 h-48 rounded-full pointer-events-none opacity-10"
                style={{ background: "radial-gradient(circle, #D91A6B 0%, transparent 70%)" }} />
              <h4
                className="font-display text-[#FFFFFF] text-2xl font-semibold mb-2 relative"
                style={{ fontVariationSettings: '"WONK" 0.5' }}
              >
                Your Blueprint to Online Success Awaits
              </h4>
              <p className="font-body text-[#FFFFFF]/55 text-sm mb-7 relative">
                Start Building Now
              </p>
              <div className="relative">
                <SignupForm onSubmit={() => setSubmitted(true)} submitted={submitted} />
              </div>
              <p className="font-body text-[#FFFFFF]/30 text-xs mt-5 leading-relaxed relative">
          ...
          {/* Wambui Bio */}
          <div className={`grid lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-start bg-white rounded-sm p-8 lg:p-12 border border-[#E8E8E8] wabs-shadow transition-[opacity,transform] duration-700 ease-out delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="shrink-0 mx-auto lg:mx-0">
              <div className="w-40 h-40 lg:w-52 lg:h-52 rounded-full overflow-hidden border-4 border-[#D91A6B]/20">
                <Image
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-6 h-px bg-[#D91A6B]" />
                <span className="font-stat text-[#D91A6B] text-sm uppercase tracking-widest font-medium">
                  Meet Your Guide
                </span>
              </div>
              <h3
                className="font-display text-[#111111] leading-tight mb-1"
                style={{ fontSize: "clamp(22px, 2.8vw, 34px)", fontVariationSettings: '"WONK" 0.5' }}
              >
                Wambui Kuria
              </h3>
              <p className="font-body text-[#D91A6B] font-semibold text-sm mb-5">Founder, WABS Digital</p>
              <p className="font-body text-[#2D2D2D]/65 text-base leading-relaxed mb-4">
              ...
              <p className="font-body text-[#2D2D2D]/65 text-base leading-relaxed">
                ...
                <span className="font-semibold text-[#111111]">100 more of you</span> this year!
              </p>

              {/* WABS Mission */}
              <div className="mt-8 pt-8 border-t border-[#E8E8E8]">
                <p className="font-body text-[#111111]/55 text-sm uppercase tracking-widest font-semibold mb-3">At WABS, we believe</p>
                <p className="font-display text-[#111111] text-lg leading-relaxed italic" style={{ fontVariationSettings: '"WONK" 0.3' }}>
